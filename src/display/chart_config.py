    ...
    return {
        "subplots": [
            ...
            },
            {
                ...
                "height": 0.7,  # Fraction of total chart height
                ...
                "traces": [
                   ...
                   
                    {
                        "type": "line",
                        "name": "High Remain",
                        "columns": {"x": "datetime", "y": "day_high_remaining"},
                        "style": {"color": "rgba(0, 0, 0, 0.5)", "width": 2, "dash": "dash"}
                    },
                    {
                        "type": "line",
                        "name": "Low Remain",
                        "columns": {"x": "datetime", "y": "day_low_remaining"},
                        "style": {"color": "rgba(0, 0, 0, 0.5)", "width": 2, "dash": "dash"}
                    },
                        ...
                        "style": {"color": "rgba(0, 0, 0, 0.5)", "width": 2, "dash": "dot"}
                    },
                    {
                        "type": "line",
